function [x,functionParams,params,l,u] = gen_case_3(N,T)
...
% Case_3: infeasible start case. check decline patter
% All wells have the same GLR but different decline rate
% well #3 has the smallest decline rate
